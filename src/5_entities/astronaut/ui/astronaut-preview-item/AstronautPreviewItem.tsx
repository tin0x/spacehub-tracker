...
import type { AstronautPreviewItemProps } from '@entities/astronaut/types.ts';

const AstronautPreviewItem: React.FC<AstronautPreviewItemProps> = ({ id, imageUrl, imageAlt, name, agency }) => {
  return (
    <Link
...
export default AstronautPreviewItem;
